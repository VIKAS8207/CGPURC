    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
          ...
          <Link to="/user/verify-duplicate-requests" className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors ${isActive('/user/verify-duplicate-requests') ? 'bg-orange-50 text-orange-700 font-semibold hover:bg-orange-100' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900'}`}>
  <FileCheck2 size={20} className={isActive('/user/verify-duplicate-requests') ? 'text-orange-600' : 'text-slate-400'} />
  {isSidebarOpen && <span>Verify Duplicate Request</span>}
</Link>
