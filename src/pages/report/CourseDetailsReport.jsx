...
const CourseDetailsReport = () => {
  ...
  // --- CALCS ---
  const totalPages = Math.ceil(courseDetailsData.length / itemsPerPage) || 1;
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative flex items-center group">
                  <select 
                    ...
                    className="w-[4.5rem] bg-white border border-slate-200 text-slate-700 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block py-1.5 pl-3 pr-7 outline-none shadow-sm transition-all font-semibold cursor-pointer hover:border-orange-300 hover:bg-orange-50/50 appearance-none"
                  >
