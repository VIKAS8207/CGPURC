...
import { 
  ArrowLeft, Briefcase, Plus, Search, 
...
const AdminOfficeBearer = () => {
    ...
    if (paths.length === 0) {
      return (
        <>
          ...
          <ChevronRight size={14} className="text-slate-400" />
          <span className="text-slate-900 font-semibold tracking-tight">Office Bearers</span>
        </>
      );
    }
  ...
  const [bearers, setBearers] = useState([
    { id: 1, name: 'Dr. Ramesh Kumar', designation: 'Vice Chancellor', phone: '+91 9876543210', email: 'vc@university.edu', department: 'Administration', avatar: 'https://i.pravatar.cc/150?u=1' },
    { id: 2, name: 'Anita Sharma', designation: 'Registrar', phone: '+91 9876543211', email: 'registrar@university.edu', department: 'Management', avatar: 'https://i.pravatar.cc/150?u=2' },
    { id: 3, name: 'Vikram Singh', designation: 'Dean of Academics', phone: '+91 9876543212', email: 'dean@university.edu', department: 'Academics', avatar: 'https://i.pravatar.cc/150?u=3' },
    { id: 4, name: 'Priya Patel', designation: 'Chief Finance Officer', phone: '+91 9876543213', email: 'cfo@university.edu', department: 'Finance', avatar: 'https://i.pravatar.cc/150?u=4' },
  ]);
    ...
    <div className="animate-in fade-in duration-500 w-full pb-10 relative">
      ...
      {showNotification && (
        <div className="fixed top-6 right-6 z-[60] animate-in slide-in-from-top-4 fade-in duration-300">
          <div className="bg-white border-l-4 border-l-[#155DFC] shadow-xl rounded-[10px] p-4 max-w-md flex items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-900">Directory Updated</h3>
              <p className="text-xs text-slate-500 mt-1">
                The office bearer directory has been successfully updated.
              </p>
            </div>
            ...
            <form onSubmit={handleEditSubmit} className="p-8 max-h-[80vh] overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <input type="text" name="department" value={editFormData.department} onChange={handleEditInputChange} required 
                    className="w-full px-4 py-2.5 bg-slate-50 border-none shadow-sm rounded-[10px] focus:outline-none focus:ring-2 focus:ring-[#155DFC]/20 transition-all font-medium text-slate-800 placeholder-slate-400" placeholder="e.g. Administration" />
                </div>
                <div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1 text-sm font-medium">Manage the official representatives and their contact details.</p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-[10px] shadow-sm mb-8 animate-in slide-in-from-top-4 fade-in duration-300 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="pt-6 border-t border-slate-100 flex justify-end">
              <button type="submit" className="w-full sm:w-auto px-8 py-2.5 text-sm font-bold text-white bg-[#155DFC] hover:bg-[#155DFC]/90 shadow-md hover:shadow-lg rounded-[10px] transition-all active:scale-95 outline-none">
                Save to Directory
              </button>
            </div>
          </form>
