...
const AcademicCalendarUpload = () => {
  ...
  const handleBulkSubmit = (e) => {
    e.preventDefault();
    console.log('Submitting Calendar Data:', bulkData);
  };
  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-7xl mx-auto">
      ...
      {/* Breadcrumb */}
      <div className="mb-6">
        <Link to="/user/uploads" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-orange-600 transition-colors">
          <ArrowLeft size={16} /> Back to Document Uploads
        </Link>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-2">Upload holidays, term dates, and exam schedules for the entire academic year.</p>
        </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 h-full flex flex-col">
                <div className="flex items-center gap-2 mb-6 border-b border-slate-200 pb-4">
                  ...
                  <h3 className="font-bold text-slate-800">Processing Overview</h3>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-100 shadow-sm flex items-center justify-between">
                    <div>
                      <p className="text-xs font-bold text-emerald-600/80 uppercase tracking-wider mb-1">Mapped Successfully</p>
                      <p className="text-xl font-bold text-emerald-800">154</p>
                    </div>
                ...
                <div className="flex-1 bg-white border border-slate-200 rounded-xl overflow-hidden flex flex-col">
                  ...
                  <div className="p-3 space-y-3 overflow-y-auto max-h-48">
                    <div className="text-xs">
                      ...
                      <p className="text-red-600">Missing 'End Date' parameter</p>
                    </div>
                    <div className="text-xs">
                      <p className="font-bold text-slate-700">Row 89: Diwali Break</p>
                      <p className="text-red-600">Invalid Event Type selected</p>
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider">Total Events</th>
            ...
            <tbody className="divide-y divide-slate-100">
              {uploadHistory.map((record) => (
                <tr key={record.id} className="hover:bg-slate-50 transition-colors group">
                  ...
                  <td className="py-4 px-6 text-slate-600 text-sm font-medium">{record.eventCount} Events</td>
        ...
        <div className="p-5 border-t border-slate-100 flex items-center justify-between text-sm bg-slate-50">
          ...
          <div className="flex gap-2">
            ...
            <button className="p-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-white bg-white transition-colors" disabled>
